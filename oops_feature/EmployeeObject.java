...
public class EmployeeObject {
	//Declaring the variables
		...
		public static void main(String[] args) 
		{
			...
			EmployeeObject obj1=new EmployeeObject("Prajwal","Hyd","Mumbai");
			EmployeeObject obj2=new EmployeeObject("Anil","Chennai","Mumbai");
			EmployeeObject obj3=new EmployeeObject("Gokul","Hyd","Mumbai");
			System.out.println("=====================================");
